...
public class TestSearch extends TestBase {
	...
	@Test
	@Parameters({ "pRfqId"})
	public void validateSearchByRFQID(String pRfqId) throws InterruptedException  {
		//String RFQID = "Q-0000";
	...
	@Test
	@Parameters({"pStatus"})
	public void validateSearchByStatus(String pStatus) throws InterruptedException  {
		//String status = "Draft";
	...
	public void validateSearchByUserName(String pUserName) throws InterruptedException  {
		//String userName = "RACKABLE";
